...
//        // Создаем объектную переменную для потока и сам поток:
    ...
    // Распознавание замкнутых линий я не знаю зачем я написал resizeImage3 скорее всего случайно добавил и нужно будет удалить:
...
//		imageLabel.repaint();
    ...
    private static void resizeImage3(MyLabel imageLabel, BufferedImage myPicture, ImageIcon imgIcon) { //распознавание замкнутых линий
        ...
        imageLabel.drawMyContour(edgesArray, Color.GREEN);
